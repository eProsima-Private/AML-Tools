...
For more information, check the :ref:`AML Dashboard Interfaces <amldashboard_interfaces_fetching>` and :ref:`AML Dashboard Usage <amldashboard_usage_fetching>` sections.
...
.. raw:: html
   ...
   <script>
      ...
      window.onload = function() {
         document.getElementById('myVideo').playbackRate = 0.75; // Set speed to 0.75x
      };
   </script>
